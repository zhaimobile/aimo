...
{    
  ...
  //printf("Time elapsed in Game:%f and V(%f,%f)\n",time_elapsed, m_vVelocity.x, m_vVelocity.y);
...
void Vehicle::Render()
{
    ...
    //[GameView drawCircleWithPosition:this->Pos() withSize:20 andColor:color];
    
    
    
    
    //a vector to hold the transformed vertices
    static std::vector<Vector2D>  static_vecVehicleVBTrans;
...
//  else
//  {
        static_vecVehicleVBTrans = WorldTransform(m_vecVehicleVB,
                                                  Pos(),
                                                  Heading(),
                                                  Side(),
                                                  Scale());
...
//
    ...
    [GameView drawPolygons:static_vecVehicleVBTrans];
